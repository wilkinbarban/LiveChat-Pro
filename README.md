...
`setup.js` validates the system Node.js installation and, if it does not exist, tries to install it. It also validates Docker/Compose and can install Docker on supported distributions.
